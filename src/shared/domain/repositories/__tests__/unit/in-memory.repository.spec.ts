...
describe('InMemoryRepository unit tests', () => {
  ...
  it('Should throw error when entity not found', async () => {
    await expect(sut.findById('fakeId')).rejects.toThrowError(
  ...
  it('Should throw error on update entity not found', async () => {
    const entity = new StubEntity({ name: 'any_name', price: 10 });
  ...
  it('Should throw error on delete entity not found', async () => {
